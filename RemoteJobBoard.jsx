...
const App = () => {
    ...
    const handleSubmitApplication = async (e) => {
        ...
        try {
            ...
            const collectionPath = `artifacts/${appId}/public/data/job_applications`;
            await addDoc(collection(db, collectionPath), applicationData);
            ...
            // Reset form (done automatically via handleApplyClick state management, but ensure local state is clear)
            ...
            <div className="bg-white p-6 md:p-10 rounded-xl shadow-2xl max-w-lg w-full transform transition-all duration-300">
                ...
                <form onSubmit={handleSubmitApplication} className="space-y-4">
                    ...
                    <p className="text-xs text-gray-500 pt-1">
                        *Note: True file upload is complex in a single-file React component. Please provide a public link to your resume document (e.g., a shared Google Drive PDF).
                    </p>
